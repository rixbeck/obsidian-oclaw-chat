...
var OpenClawChatView = class extends import_obsidian2.ItemView {
  ...
  _renderAssistantPlainWithLinks(body, text, mappings, sourcePath) {
    ...
    const tryReverseMapUrlToVaultPath = (url) => {
      var _a;
      let decoded = url;
      try {
