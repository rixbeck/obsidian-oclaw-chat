...
var OpenClawChatView = class extends import_obsidian2.ItemView {
  ...
  _installInternalLinkDelegation() {
    ...
    const handler = (ev) => {
      ...
      if (!((_a = this.messagesEl) == null ? void 0 : _a.contains(target)))
        return;
      const a = (_b = target.closest) == null ? void 0 : _b.call(target, 'a.internal-link, a[href^="oclaw-open:"]');
      if (!a)
        return;
      ...
      if (hrefAttr.startsWith(OCLAW_OPEN)) {
        ...
        let vaultPath2 = "";
        try {
          vaultPath2 = decodeURIComponent(encoded);
        } catch (e) {
          vaultPath2 = encoded;
        }
        vaultPath2 = vaultPath2.replace(/^\/+/, "");
        ev.preventDefault();
        ev.stopPropagation();
        const f2 = this.app.vault.getAbstractFileByPath(vaultPath2);
        if (f2 instanceof import_obsidian2.TFile) {
          void this.app.workspace.getLeaf(true).openFile(f2);
          return;
        }
        void this.app.workspace.openLinkText(vaultPath2, (_d = (_c = this.app.workspace.getActiveFile()) == null ? void 0 : _c.path) != null ? _d : "", true);
        return;
      }
      ...
      void this.app.workspace.openLinkText(vaultPath, (_f = (_e = this.app.workspace.getActiveFile()) == null ? void 0 : _e.path) != null ? _f : "", true);
    };
  ...
  _preprocessAssistantMarkdown(text, mappings) {
    ...
    const tryResolveVaultPath = (raw) => {
      ...
      if (fromUrl && this.app.vault.getAbstractFileByPath(fromUrl))
        return fromUrl;
      return null;
    };
